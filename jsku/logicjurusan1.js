$(document).ready(function () {
    ...
    if (val == "Akuntansi") {
        ...
        $("#form1 #prodi1").html('<option disabled selected>Pilih Program Studi...</option><option value="D3 Teknik Mesin">D3 Teknik Mesin</option><option value="Teknik Mesin & Perawatan">Teknik Mesin & Perawatan</option><option value="Teknik Konversi Energi">Teknik Konversi Energi</option>');
    } else if (val == "Teknik Elektro") {
        $("#form1 #prodi1").html('<option disabled selected>Pilih Program Studi...</option><option value="Teknik Listrik">Teknik Listrik</option><option value="Teknik Telekomunikasi">Teknik Telekomunikasi</option><option value="Teknik Informatika">Teknik Informatika</option>');
